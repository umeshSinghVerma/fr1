...
import ProfileAvatar from "public/avatarPlaceholder.png"
    ...
    return (
        <div className="relative border-t lg:border-none">
            <div className="">
                ...
                >
                    <Image
                        src={session?.data?.user?.image || ProfileAvatar}
            ...
            <nav className="border-b">
                <ul className="flex items-center gap-x-3 max-w-screen-xl mx-auto px-4 overflow-x-auto lg:px-8">
                    <button
                        ...
                        data-te-ripple-init=""
                    >
                        <span className="block [&>svg]:h-5 [&>svg]:w-5 [&>svg]:text-slate-900">
                            <svg
