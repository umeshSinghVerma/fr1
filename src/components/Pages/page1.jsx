...
export default function Page1(props) {
  ...
  return (
    <div className="flex flex-col max-w-full p-4  gap-y-8">
      <div className="flex min-[450px]:py-0 gap-x-2 rounded-2xl justify-between flex-wrap gap-y-4 items-center px-4 md:px-8 ">
        <div className="flex gap-x-4 items-center">
            <span>
            צהריים טובים, מתן
            </span>
          <span
            className={`px-3 py-2 rounded-lg font-semibold text-xs text-[#D15292] bg-[#d152921a]`}
          >
            השלם הגדרות פרופיל
          </span>
        </div>
            ...
            <div className="flex flex-wrap gap-y-2 justify-between items-center">
              ...
              <div className="flex items-center justify-center text-xs">
                <Link
                  replace
                  href="/home/table/1"
                  className={`flex items-center justify-center p-2 rounded-t-lg gap-2 ${
                    currentComp == 1 ? "bg-gray-200" : "bg-gray-50"
                  }`}
                >
                  <p
                    className=" rounded-[50%] w-4 flex justify-center items-center h-4 text-white bg-[#D15292]"
                    style={{ fontSize: "10px" }}
                  >
                    1
                  </p>
                ...
                <Link
                  replace
                  href="/home/table/2"
                  className={` rounded-t-lg flex items-center justify-center p-2 gap-2 ${
                    currentComp == 2 ? "bg-gray-200" : "bg-gray-50"
                  }`}
                >
                  <p
                    className=" rounded-[50%] w-4 flex justify-center items-center h-4 text-white bg-[#D15292]"
